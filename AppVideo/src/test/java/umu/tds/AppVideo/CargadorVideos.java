...
//		for(Video v : AdaptadorVideoTDS.getUnicaInstancia().recuperarTodosVideos()) {
...
//		System.out.println((int)Math.ceil(16));
		
		
//		String original = "patata atomica voladora";
//		// Para ver si contiene algo, usamos contains
//		String subcadena = "patata atu";
